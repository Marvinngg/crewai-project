...
('identify_task', 'Analyze and select the best city for the trip based
...
City Options: {cities}
Trip Date: {range}
Traveler Interests: {interests}',1, 'A json object containing the chosen city, flight costs, weather forecast, and attractions.');

INSERT INTO tasks (name, description,agent_id, expected_output) VALUES
('gather_task', 'As a local expert on this city you must compile an
...
Trip Date: {range}
Traveling from: {origin}
Traveler Interests: {interests}',1, 'A json object containing a comprehensive city guide with key attractions, local customs, special events, daily recommendations, hidden gems, cultural hotspots, must-visit landmarks, weather forecasts, and high level costs.');

INSERT INTO tasks (name, description,agent_id, expected_output) VALUES
('plan_task', 'Expand this guide into a full 7-day travel
...
each place, what makes them special!',1,

'A json object containing a full 7-day travel itinerary with daily schedules, weather forecasts, places to eat, packing suggestions, and a budget breakdown.');
ALTER TABLE tasks
DROP COLUMN tools;
ALTER TABLE agents
ADD COLUMN tools JSON;
INSERT INTO agents (name, role, goal, backstory, tools) VALUES
('city_selection_agent', 'City Selection Expert', 'Select the best city based on weather, season, and prices',
 'An expert in analyzing travel data to pick ideal destinations',
 '["SearchTools.search_internet", "BrowserTools.scrape_and_summarize_website"]'),

('local_expert_agent', 'Local Expert at this city', 'Provide the BEST insights about the selected city',
 'A knowledgeable local guide with extensive information about the city, it\'s attractions and customs',
 '["SearchTools.search_internet", "BrowserTools.scrape_and_summarize_website"]'),

('travel_concierge_agent', 'Amazing Travel Concierge', 'Create the most amazing travel itineraries with budget and packing suggestions for the city',
 'Specialist in travel planning and logistics with decades of experience',
 '["SearchTools.search_internet", "BrowserTools.scrape_and_summarize_website", "CalculatorTools.calculate"]')
INSERT INTO agents (name, role, goal, backstory, tools) VALUES
('research_manager', 'Company Research Manager',
 'Generate a list of JSON objects containing the urls for 3 recent blog articles and the url and title for 3 recent YouTube interviews, for each position in each company.
 Important:
...
('research_agent', 'Company Research Agent',
 'Look up the specific positions for a given company and find urls for 3 recent blog articles and the url and title for 3 recent YouTube interview for each person in the specified positions.
 Important:
...
INSERT INTO tasks (name, description, agent_id, expected_output) VALUES
('manage_research_task',
 'Based on the list of companies {companies} and the positions {positions}, use the results from the Company Research Agent to research each position in each company to put together a json object containing the URLs for 3 blog articles, the URLs and title for 3 YouTube interviews for each position in each company.',
 1,
 'A json object containing the URLs for 3 blog articles and the URLs and titles for 3 YouTube interviews for each position in each company.'),
('company_research_task',
 'Research the position {positions} for the {company} company. For each position, find the URLs for 3 recent blog articles and the URLs and titles for 3 recent YouTube interviews for the person in each position. Return this collected information in a JSON object. Helpful Tips: - To find the blog articles names and URLs, perform searches on Google such like the following: - "{company} [POSITION HERE] blog articles" - To find the youtube interviews, perform searches on YouTube such as the following: - "{company} [POSITION HERE] interview" Important: - Once you\'ve found the information, immediately stop searching for additional information. - Only return the requested information. NOTHING ELSE! - Do not generate fake information. Only return the information you find. Nothing else! - Do not stop researching until you find the requested information for each position in the company.',
 1,
 'A JSON object containing the researched information for each position in the company.');

INSERT INTO agents (name, role, goal, backstory, tools) VALUES
('company_information_collector', 'Company Information Collector',
 'Collect comprehensive company information and data for analysis,The data is preferably cutting-edge,latest (2024), authoritative, and significant',
 'Experienced in gathering and organizing company-related data for analysis',
 '["BrowserTools.scrape_and_summarize_website", "SearchTools.search_internet"]'),

('company_analyst', 'Company Analyst',
 'Based on the data obtained from the search, analyze the company condition and form an analysis report',
 'Proficient in analyzing company profiles and assessing corporate health',
 '["BrowserTools.scrape_and_summarize_website", "SearchTools.search_internet"]');
INSERT INTO agents (name, role, goal, backstory, tools) VALUES
('industy_information_collector', 'Industry Information Collector',
 'Collect comprehensive industry information and data for analysis,The data is preferably cutting-edge,latest (2024), authoritative, and significant',
 'Experienced in gathering and organizing industry-related data for analysis',
 '["BrowserTools.scrape_and_summarize_website", "SearchTools.search_internet"]'),

('industy_analyst', 'Industry Analyst',
 'According to the data obtained from the search, analyze the industry status and form the industry analysis report',
 'Experienced in analyzing industry data to identify trends, forecast market movements',
 '["BrowserTools.scrape_and_summarize_website", "SearchTools.search_internet"]');
INSERT INTO agents (name, role, goal, backstory, tools) VALUES
('macroeconomic_information_collector', 'Macroeconomic Information Collector',
 'Collect comprehensive macro economic information and data for analysis,The data is preferably cutting-edge,latest (2024), authoritative, and significant',
 'Experienced in gathering and organizing macroeconomic data for analysis',
 '["BrowserTools.scrape_and_summarize_website", "SearchTools.search_internet"]'),

('macroeconomic_analyst', 'Macroeconomic Analyst',
 'Analyze macroeconomic data and trends, and provide insights and macroeconomic analysis report',
 'Experienced in analyzing macroeconomic trends and forecasting',
 '["BrowserTools.scrape_and_summarize_website", "SearchTools.search_internet"]');
INSERT INTO tasks (name, description, agent_id, expected_output) VALUES
('collect_company_information_task',
 'Collect comprehensive company information and data for analysis',
 1,
 'A JSON object containing financial reports, market data, business operations, and strategic positioning for the company.'),

('analyze_task',
 'Analyze the collected company information and generate a detailed analysis report',
 1,
 'A JSON object containing the researched information and analysis, including financial reports, market data, business operations, strategic positioning, and a detailed analysis.');
INSERT INTO tasks (name, description, agent_id, expected_output) VALUES
('collect_industry_information_task',
 'Collect comprehensive industry information and data for analysis',
 2,
 'A JSON object containing the market size, growth rate, key players, competitive landscape, regulatory environment, and technological advancements for the industry.'),

('analyze_industry_task',
 'Analyze the collected industry information and generate a detailed analysis report',
 2,
 'A JSON object containing the researched information and analysis, including market size, growth rate, key players, competitive landscape, regulatory environment, technological advancements, and a detailed analysis.');
INSERT INTO tasks (name, description, agent_id, expected_output) VALUES
('collect_macroeconomic_task',
 'Collect comprehensive macroeconomic information and data for analysis',
 3,
 'A JSON object containing the GDP, inflation rate, unemployment rate, interest rate, trade balance, and fiscal deficit for the country.'),

('analyze_task',
 'Analyze the collected macroeconomic information and generate a detailed analysis report',
 3,
 'A JSON object containing the researched information and analysis, including GDP, inflation rate, unemployment rate, interest rate, trade balance, fiscal deficit, and a detailed analysis.');
